...
def loop_and_detect(cam, tf_sess, conf_th, vis, od_type):
    ...
    zone_x_bed = 0
    zone_y_bed = 0
    #zone_x_min_bed,zone_y_min_bed,zone_x_max_bed,zone_y_max_bed = 50,130,200,400
    zone_x_min_bed,zone_y_min_bed,zone_x_max_bed,zone_y_max_bed = 840,500,1300,1000
    zone_x_clean = 0
    zone_y_clean = 0
    #zone_x_min_clean,zone_y_min_clean,zone_x_max_clean,zone_y_max_clean = 600,130,400,410
