...
def main():
    while True:
        ...
        if(time_to_work_min == True):
            ...
            #client = mqtt.Client()     --> need to be reactiviated
            #client.connect("localhost",1883,60) --> need to be reactiviated
            #client.loop_start() --> need to be reactiviated
            ...
            #client.publish("MDSSCC/AIHH/gui_dashboard", mqtt_message) --> need to be reactiviated
            #client.loop_stop() --> need to be reactiviated
            #client.disconnect() --> need to be reactiviated
            #client.loop()
