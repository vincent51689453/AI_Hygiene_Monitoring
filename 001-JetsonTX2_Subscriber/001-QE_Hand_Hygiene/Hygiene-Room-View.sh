...
#python3 Hygiene_Tracking_Room_Subscriber.py --file --filename ./videos/RTSP_Room_View_Ready.mp4 --model ssd_mobilenet_v1_coco  --num-classes 1 --confidence 0.35


#Running Demo Video Room_Hygiene_Demo_12_5fps
python3 Hygiene_Tracking_Room_Subscriber.py --file --filename ./video/Case2_Vincent_Normal.mp4 --model ssd_mobilenet_v1_coco  --num-classes 1 --confidence 0.4
