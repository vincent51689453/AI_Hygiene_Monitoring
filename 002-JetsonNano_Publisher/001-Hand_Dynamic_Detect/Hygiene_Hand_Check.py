...
BLACK = (0, 0, 0)
WHITE = (255, 255, 255)
zone_x_min_clean,zone_y_min_clean,zone_x_max_clean,zone_y_max_clean = 100,200,1500,1080
...
class BBoxVisualization():
    ...
    def draw_bboxes(self, img, box, conf, cls):
        ...
        for bb, cf, cl in zip(box, conf, cls):
            ...
            #Moving Threshold
            if(distance <= 70):                    
                cv2.line(img,(center_x,center_y),(center_x_old,center_y_old),(255,255,0),2) 
                delay_counter+=1
            print("Delay_Counter:",delay_counter)
            if(delay_counter == max_wash):
                box_wash = True
                cv2.rectangle(img, (x_min-40, y_min-40), (x_max+40, y_max+40), (255,0,255), 2)
                cv2.putText(img, "DYNAMIC MOTION:WASH", (x_min-80, y_min-80),cv2.FONT_HERSHEY_SIMPLEX, 1,(255,0,255), 2)
                delay_counter = 0
                print("Dynamic Related Motion: Hand Washing")
